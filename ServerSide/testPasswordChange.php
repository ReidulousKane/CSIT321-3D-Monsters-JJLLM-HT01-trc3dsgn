<?php
    ...
    mysqli_select_db($db, "joshuagr_3DMonstersTest") or die("Could not select database: joshuagr_3DMonstersTest");
    ...
    if($real_hash == $hash)
    {
	    ...
	    $sqlResult = mysqli_query($db, $query) or die("Query failed: " . mysql_error($db));
